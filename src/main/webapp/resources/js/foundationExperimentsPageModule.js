...
var foundationExperimentsPageModule = (function ($) {
    ...
    function formatExperimentType(data, contextPath) {
        ...
        if (data === 'RNASEQ_MRNA_DIFFERENTIAL' ||
            data === 'MICROARRAY_1COLOUR_MRNA_DIFFERENTIAL' ||
            data === 'MICROARRAY_2COLOUR_MRNA_DIFFERENTIAL' ||
            data === 'MICROARRAY_1COLOUR_MICRORNA_DIFFERENTIAL') {
