...
public class ExperimentCrudIT {
    ...
    @Test
    public void importReloadDeleteRnaSeqBaselineExperiment() {
    ...
    @Test
    public void importReloadDeleteRnaSeqDifferentialExperiment() {
        testImportNewImportExistingAndDelete(RNASEQ_DIFFERENTIAL);
    }

    @Test
    public void importReloadDeleteProteomicsBaselineExperiment() {
    ...
    @Test
    public void
    findAllExperimentsFindsPrivateExperiments() {
    ...
    private void
    importNewExperimentInsertsDB(String experimentAccession) {
    ...
    private void
    importExistingExperimentUpdatesDB(String experimentAccession) {
