...
public class EvidenceServiceTest {
    ...
    private Contrast c1 = new Contrast("g1_g2", "first contrast", referenceAssay1, testAssay1, null);
    private Contrast c2 = new Contrast("g3_g4", "second contrast", referenceAssay2, testAssay2, null);
