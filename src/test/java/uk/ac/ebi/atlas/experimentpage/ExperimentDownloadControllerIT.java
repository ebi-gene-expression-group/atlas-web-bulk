...
class ExperimentDownloadControllerIT {
    ...
    void testSomeMicroarrayExperiments(String accession) {
    ...
    void testSomeRnaSeqExperiments(String accession) throws Exception {
    ...
    @ParameterizedTest
    @MethodSource("rnaSeqBaselineExperimentAccessionProvider")
    void testSomeRnaSeqBaselineExperiments(String accession) throws Exception {
    ...
    @ParameterizedTest
    @MethodSource("proteomicsBaselineExperimentAccessionProvider")
    void testSomeProteomicsBaselineExperiments(String accession) throws Exception {
        BaselineExperiment experiment = (BaselineExperiment) experimentTrader.getPublicExperiment(accession);
