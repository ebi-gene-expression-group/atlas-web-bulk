...
//                new AssayGroup(
//                        "g1",
//                        ImmutableSet.of(BiologicalReplicate.create(ASSAY1), BiologicalReplicate.create(ASSAY2)));
//        AssayGroup testAssayGroup =
//                new AssayGroup(
//                        "g2",
//                        ImmutableSet.of(BiologicalReplicate.create(ASSAY3), BiologicalReplicate.create(ASSAY4)));
//        Contrast contrast1 =
//                new Contrast(
//                        CONTRAST_ID, "display name", referenceAssayGroup, testAssayGroup, "array design accession");
//
