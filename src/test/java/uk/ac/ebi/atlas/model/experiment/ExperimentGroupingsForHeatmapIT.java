...
import uk.ac.ebi.atlas.experimentpage.columngroups.HeatmapFilterGroup;
import uk.ac.ebi.atlas.experimentpage.columngroups.HeatmapGroupingsService;
...
class ExperimentGroupingsForHeatmapIT {
    ...
    void outputInFineFormatForExperiment(String accession) {
        Experiment<? extends ReportsGeneExpression> experiment = experimentTrader.getPublicExperiment(accession);
