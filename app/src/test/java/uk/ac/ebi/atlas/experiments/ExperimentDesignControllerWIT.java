...
class ExperimentDesignControllerWIT {
    ...
    void populateDatabaseTables() {
        ...
        populator.addScripts(
                ...
                new ClassPathResource("fixtures/gxa_exp_design_column.sql"),
                new ClassPathResource("fixtures/gxa_exp_design.sql"));
    ...
    void cleanDatabaseTables() {
        ResourceDatabasePopulator populator = new ResourceDatabasePopulator();
        populator.addScripts(
                new ClassPathResource("fixtures/gxa_exp_design-delete.sql"),
                new ClassPathResource("fixtures/gxa_exp_design_column-delete.sql"),
